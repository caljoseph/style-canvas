...
class BaseOptions():
    ...
    def parse(self, save=True):
        ...
        # Set isTrain attribute based on application logic or a command-line argument
        self.opt.isTrain = self.isTrain  # This needs to be defined somewhere

        # Automatically detect the number of GPUs available and set gpu_ids
        num_gpus = torch.cuda.device_count()
        self.opt.gpu_ids = list(range(num_gpus))
